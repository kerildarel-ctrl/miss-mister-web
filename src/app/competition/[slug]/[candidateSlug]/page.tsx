    ...
    return (
      <>
        ...
        <main className="min-h-[60vh] bg-[#F8FAFC] py-20 text-center font-poppins space-y-4 px-4">
          ...
          <p className="text-xs sm:text-sm text-slate-500">Le profil demandé n&apos;existe pas dans cette compétition.</p>
  ...
  return (
    <>
      ...
      <main className="flex-1 min-h-screen py-6 sm:py-10 px-3 sm:px-6 lg:px-8 max-w-6xl mx-auto space-y-6 sm:space-y-8 font-poppins bg-[#F8FAFC]">
        ...
        >
          <ArrowLeft className="w-4 h-4 text-amber-600" /> Retour à {competition.title}
        </Link>

        {/* Candidate Detail Card Layout - ULTRA RESPONSIVE */}
