  ...
  return (
    <>
      ...
      <main className="flex-1 overflow-hidden font-poppins bg-[#F8FAFC]">
        ...
        {/* ========================================================================= */}
        {/* FIRST SCREEN (HERO): PURE PRESTIGE BRANDING WITH GOLD HIGHLIGHTS */}
        {/* ========================================================================= */}
        <section className="relative min-h-[85vh] flex flex-col justify-center items-center text-center px-4 sm:px-6 lg:px-8 max-w-7xl mx-auto overflow-hidden py-16">
          ...
          <div className="relative z-10 max-w-4xl mx-auto space-y-8">
            ...
            {/* Animated Royal Crown Badge with Gold Highlight */}
            <motion.div
              initial={{ opacity: 0, scale: 0.8 }}
              animate={{ opacity: 1, scale: 1 }}
              className="inline-flex items-center gap-2.5 px-5 py-2 rounded-full bg-white/95 backdrop-blur-md border border-amber-300 shadow-sm text-amber-600 text-xs font-extrabold uppercase tracking-widest mx-auto"
            >
              <Crown className="w-4 h-4 text-amber-500 fill-amber-400 animate-bounce" />
              <span>LA PLATEFORME OFFICIELLE DE VOTE EN LIGNE</span>
            </motion.div>

            {/* Giant Title with Gold Highlight on Key Brand Word */}
            <motion.div
            ...
            >
              <h1 className="text-6xl sm:text-7xl lg:text-8xl font-black tracking-tight leading-none text-slate-900">
                ...
                <span className="gradient-text-gold drop-shadow-sm">MISTER</span>
              </h1>
            ...
            >
              <div className="relative flex items-center bg-white p-2 rounded-2xl border border-amber-200 shadow-xl">
                ...
                <Link
                  ...
                  className="gold-gradient-btn py-3 px-6 rounded-xl font-extrabold text-xs text-slate-950 uppercase tracking-wider flex-shrink-0 flex items-center gap-1.5 shadow-md"
                >
                  <span>Explorer</span>
            ...
            >
              <Link
                href="/competitions"
                className="gold-gradient-btn py-4 px-8 rounded-2xl text-sm font-extrabold text-slate-950 uppercase tracking-wider flex items-center gap-2 shadow-xl hover:scale-105 transition-transform"
              >
              ...
              <Link
                href="/classement"
                className="py-4 px-8 rounded-2xl bg-white border border-amber-200 text-amber-700 hover:bg-amber-50 text-sm font-extrabold flex items-center gap-2 shadow-md transition-colors"
              >
          ...
          {/* Live Metrics Counter Bar at bottom of Hero with Gold Highlights */}
          <motion.div
            initial={{ opacity: 0, y: 30 }}
            animate={{ opacity: 1, y: 0 }}
            transition={{ delay: 0.5 }}
            className="w-full max-w-5xl mx-auto mt-16 bg-white/90 backdrop-blur-md rounded-3xl p-6 border border-amber-200 shadow-xl grid grid-cols-2 md:grid-cols-4 gap-6 text-center"
          >
            ...
            <div className="space-y-1">
              ...
              <p className="text-3xl font-black text-amber-500 font-mono">{totalVotes.toLocaleString('fr-FR')} votes</p>
            </div>
        ...
        <section className="py-20 px-4 sm:px-6 lg:px-8 max-w-7xl mx-auto space-y-16">
          ...
          <div className="text-center space-y-3 max-w-2xl mx-auto">
            <div className="inline-flex items-center gap-2 px-4 py-1.5 rounded-full bg-amber-50 border border-amber-200 text-xs font-extrabold text-amber-600 uppercase tracking-widest">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
            ...
            {/* Step 1 */}
            <div className="bg-white p-8 rounded-3xl border border-slate-200 shadow-md hover:shadow-xl hover:border-amber-300 transition-all duration-300 space-y-4 text-center group">
              <div className="w-16 h-16 rounded-2xl bg-amber-50 text-amber-600 flex items-center justify-center mx-auto group-hover:scale-110 transition-transform shadow-sm border border-amber-200">
                <Trophy className="w-8 h-8" />
              </div>
              <span className="inline-block text-xs font-black text-amber-600 font-mono bg-amber-50 px-3 py-1 rounded-full border border-amber-200">
                ÉTAPE 01
              </span>
        ...
        {/* ========================================================================= */}
        {/* THIRD SECTION: SECURITY & ENGAGEMENT BANNER WITH GOLD ACCENT */}
        {/* ========================================================================= */}
